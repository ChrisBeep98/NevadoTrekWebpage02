window.NT_I18N=(function(){
  var dict={
    es:{
      ...
      "footer.tagline":"Donde la tierra toca el cielo y el silencio se vuelve eterno.",
      "footer.rights":"© 2025 Nevado Trek. Todos los derechos reservados.",
    ...
    en:{
      ...
      "footer.tagline":"Where the earth touches the sky and silence becomes eternal.",
      "footer.rights":"© 2025 Nevado Trek. All rights reserved.",
